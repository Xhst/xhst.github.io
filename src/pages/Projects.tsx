...
const Projects = () => {
    ...
    useEffect(() => {
        const fetchRepositories = async () => {
            try {
                ...
                setLoading(false); // Imposta il caricamento a false dopo il recupero
            }
        };
    ...
    const getRandomPath = () => {
        const paths = [
            ...
            "M0,320L34.3,309.3C68.6,299,137,277,206,245.3C274.3,213,343,171,411,138.7C480,107,549,85,617,106.7C685.7,128,754,192,823,208C891.4,224,960,192,1029,165.3C1097.1,139,1166,117,1234,112C1302.9,107,1371,117,1406,122.7L1440,128L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z",
